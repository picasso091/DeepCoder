    ...
    # print('--------------', tf.__version__)
        if 'vanilla' in request.POST:
            try:
                ...
                predicted_vanilla = predicted_vanilla.replace('}', '}\n')
                # else:
                predicted_vanilla = predicted_vanilla.replace('< i', '<i').replace('\r', '')
                predicted_vanilla = predicted_vanilla.replace('m >', 'm>\n')
            ...
            try:
                ...
                predicted_t5 = predicted_t5.replace('\n', ' ').replace('\r', '')
                predicted_t5 = predicted_t5.replace(' ;', ';').replace('< i', '<i').replace('m >', 'm> \n').replace('using','\n using')
                predicted_t5 = predicted_t5.replace(';', ';\n').replace('{', '{\n')
